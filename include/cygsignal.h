...
typedef struct
{
  ...
  __extension__ union
  {
    unsigned int __pad[__SI_PAD_SIZE];	/* plan for future growth */
    ...
    __extension__ struct
    {
      unsigned int __pad2[__SI_CYG_PAD];	/* Locate at end of struct */
